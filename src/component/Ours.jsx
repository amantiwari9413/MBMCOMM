    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center xl:max-w-2xl">
            <h2 className="text-3xl font-bold leading-tight text-gray-50 sm:text-4xl xl:text-5xl mb-6">We are just
                getting started!</h2>
            <p className="mb-4">We are creating a tool that helps you be more productive and efficient when you in collage </p>
        </div>
        <div className="grid max-w-4xl lg:max-w-6xl grid-cols-1 mx-auto mt-8 text-center gap-y-4 sm:gap-x-8 sm:grid-cols-2 lg:grid-cols-3 sm:mt-12 lg:mt-20 sm:text-left">
            <div className="relative">
                <div className="absolute -inset-1">
                    <div
                        className="w-full h-full rotate-180 opacity-70 blur-lg filter bg-gradient-to-r from-orange-600 via-blue-600 to-green-600">                     </div>
                </div>
                <div className="relative overflow-hidden bg-gradient-to-t from-yellow-200 via-blue-200 to-green-100 shadow-md rounded-xl h-full">
            ...
            <div className="overflow-hidden bg-gradient-to-t from-yellow-200 via-blue-200 to-green-100 shadow-md rounded-xl ">
                <div className="p-9"><svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24" fill="none"
                    ...
                    <h3 className="mt-6 text-2xl font-bold text-gray-900 sm:mt-10">Pervious Paper</h3>
                    <p className="mt-6 mb-5 text-base text-gray-600">Here your you can your pervious year question in high qulity</p>
                  <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-transparent px-6 font-medium text-neutral-600 transition-all duration-100 [box-shadow:5px_5px_rgb(82_82_82)] active:translate-x-[3px] active:translate-y-[3px] active:[box-shadow:0px_0px_rgb(82_82_82)]">Click me</button>
                </div>
            ...
            <div className="relative">
                <div className="absolute -inset-1">
                    <div
                        className="w-full h-full rotate-180 opacity-70 blur-lg filter bg-gradient-to-r from-blue-500 via-pink-500 to-green-600">
                    </div>
                </div>
                <div className="relative overflow-hidden  bg-gradient-to-t from-yellow-200 via-blue-200 to-green-100 shadow-md rounded-xl h-full">
                    <div className="p-9"><svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24"
                        ...
                        <p className="mt-6 mb-5 text-base text-gray-600">On this platform you can get everything we integrate all this to gether </p>
                            <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-transparent px-6 font-medium text-neutral-600 transition-all duration-100 [box-shadow:5px_5px_rgb(82_82_82)] active:translate-x-[3px] active:translate-y-[3px] active:[box-shadow:0px_0px_rgb(82_82_82)]">Click me</button>
                    </div>
                </div>
            </div>
            ...
            <div className="overflow-hidden  bg-gradient-to-t from-yellow-200 via-blue-200 to-green-100 shadow-md rounded-xl">
                <div className="p-9"><svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24" fill="none"
                    ...
                    <h3 className="mt-6 text-2xl font-bold text-gray-900 sm:mt-10">Book on rent</h3>
                    <p className="mt-6 mb-5 text-base text-gray-600">Book on rent is the services where you can get book on rent</p>
                        <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-transparent px-6 font-medium text-neutral-600 transition-all duration-100 [box-shadow:5px_5px_rgb(82_82_82)] active:translate-x-[3px] active:translate-y-[3px] active:[box-shadow:0px_0px_rgb(82_82_82)]">Click me</button>
                </div>
            </div>
            ...
            <div className="relative">
                <div className="absolute -inset-1">
                    <div
                        className="w-full h-full rotate-180 opacity-50 blur-lg filter bg-gradient-to-r from-yellow-400 via-orange-500 to-green-600">
                    </div>
                </div>
                <div className="relative overflow-hidden  bg-gradient-to-t from-yellow-200 via-blue-200 to-green-100 shadow-md rounded-xl h-full">
                    <div className="p-9"><svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24"
                        ...
                        <h3 className="mt-6 text-2xl font-bold text-gray-900 sm:mt-10">Earing
                        </h3>
                        <p className="mt-6 mb-5 text-base text-gray-600">To contribute on this website you can earn money </p>
                            <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-transparent px-6 font-medium text-neutral-600 transition-all duration-100 [box-shadow:5px_5px_rgb(82_82_82)] active:translate-x-[3px] active:translate-y-[3px] active:[box-shadow:0px_0px_rgb(82_82_82)]">Click me</button>
                    </div>
                </div>
            </div>
            ...
            <div className="overflow-hidden  bg-gradient-to-t from-yellow-200 via-blue-200 to-green-100 shadow-md rounded-xl">
                <div className="p-9"><svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24" fill="none"
                    ...
                    <h3 className="mt-6 text-2xl font-bold text-gray-900 sm:mt-10">Learnn together</h3>
                    <p className="mt-6 mb-5 text-base text-gray-600">On this platform you can learn with student you just raise a requset and get resilotion </p>
                        <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-transparent px-6 font-medium text-neutral-600 transition-all duration-100 [box-shadow:5px_5px_rgb(82_82_82)] active:translate-x-[3px] active:translate-y-[3px] active:[box-shadow:0px_0px_rgb(82_82_82)]">Click me</button>
                </div>
            </div>
        </div>
